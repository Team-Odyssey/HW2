...
public class GameManager : MonoBehaviour
{
	...
	public void CreateHeroes()
	{
		...
		GameObject heroObj1 = Instantiate(HeroPrefab1, new Vector3(0, 0, 50), Quaternion.identity);
		heroObj1.GetComponentInChildren<Renderer>().material.color = Players[0].Color;
		
		Hero hero1 = heroObj1.GetComponent<Hero>();

		GameObject heroObj2 = Instantiate(HeroPrefab2, new Vector3(0, 0, -50), new Quaternion(0, -180, 0, 0));
